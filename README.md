...
- 🛠️ Building bots, infra tools, and backend systems  
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=cpp,nodejs,ts,java,py,bash,mysql,mongodb,linux,docker,git,html,tailwind,vscode" />
</p>
...
- 🤖 **Interactive Discord Bot** – Credit system, webhooks, receipts, slash UI
- ☁️ **MalluCloud Hosting** – Clean, affordable hosting for devs (India-first)
- 🔐 **MySQL GDrive Backuper** – Bash + `rclone` = secure auto backups
- 🧠 **Security Scripts** – Auth, firewall, monitor, log parsers
- ⚙️ **Open-source Dev Tools** – Performance testers, cronjobs, optimizers
...
> _“Turning pain into passion.  
> Building things that solve problems.  
> Always learning. Always leveling up.”_
